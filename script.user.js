...
(function() {
    ...
    window.addEventListener("load", async(e) => {
        let promises = ["https://unpkg.com/swiper@9.0.5/swiper-element-bundle.min.js", "https://unpkg.com/htm@3.1.1/dist/htm.umd.js"].map(e=>fetch(e).then(e=>e.text()).then(e=>eval(e)))
            ...
            [1818587769], {
                1818587769: (module, exports, require) => {
                    ...
                    function Slides({content, closeLightbox, carouselIndex}) {
                      ...
                      return html`
                        <swiper-container ref=${swiperElRef} navigation="true" pagination="true" class="fixed inset-0 z-10 bg-notBlack bg-opacity-90 backdrop-blur" style=${{"--swiper-theme-color":"rgb(var(--color-accent))","--swiper-pagination-bullet-inactive-color":"rgb(var(--color-notWhite))", "--easrng-swiper-controls": hideControls? "0":undefined}}>
